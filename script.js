...
for (let i = 0; i < kanjiData.length; i++) {
  if (i % 100 == 0) {
    ...
    if (i != 0) {
      document.getElementById("kanjiList").appendChild(ruler);
    }
  ...
  para.innerHTML = kanjiData[i];
  document.getElementById("kanjiList").appendChild(para);

  const space = document.createElement("span");
  space.innerHTML = "&emsp;";
  document.getElementById("kanjiList").appendChild(space);
}
